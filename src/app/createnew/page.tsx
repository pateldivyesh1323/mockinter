...
export default function CreateNewPage() {
    ...
    return (
        <section className="flex items-center justify-center flex-col">
            <div className="mb-6 font-semibold font-dmsans text-2xl">Create new interview</div>
            <form className="bg-white md:w-[60%] w-[90%] md:p-6 p-4" onSubmit={handleSubmit}>
                <div className="mb-6">
                ...
                <LoadingButton type="submit" className="bg-black float-right text-white p-2 rounded hover:bg-neutral-700 transition" loading={loading}>
                    Create
                </LoadingButton>
            </form>
        </section>
